      ...
      <div class="boxConteiner">
            ...
            <div class="showcase">
                ...
                <div class="login">
                    ...
                    <button class="Logout" @click="logout"  v-if="showStudentRegistration == true">Logout</button>
                ...
                <div class="showcaseHeader">                    
                    ...
                    <div class="search">
                        ...
                        <div class="contentBtnRegister">
                            <router-link to="/register"><button class="btnRegister"  v-if="showStudentRegistration == true">Cadastrar Aluno</button></router-link>
                        </div>
...
import axios from 'axios';
  ...
  export default{
    ...
    created: function(){
        ...
        if(this.axiosConfig.headers.authorization == '' || this.axiosConfig.headers.authorization == ("Bearer " + null)){
